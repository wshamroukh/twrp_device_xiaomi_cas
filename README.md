...
# Features:
- **Decryption in recovery - tested on MIUI V13.0.5.0(Android 12) && AOSP Roms(Android 12/13/14/15 with [wrapped key support](https://github.com/orgs/AcmeUI/projects/7) only)**
- MTP/ADB
- Fastbootd
- ADB Sideload
- Vibration
